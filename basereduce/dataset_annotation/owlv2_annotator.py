...
class OWLv2Annotator(BaseAnnotator):
    ...
    def __init__(self, seed: float, model_name: ModelName, task_definition: TaskList, device: str = "cuda") -> None:
    ...
    def _init_model(self):
        return Owlv2ForObjectDetection.from_pretrained("google/owlv2-base-patch16-ensemble")

    def _init_processor(self):
        return Owlv2Processor.from_pretrained("google/owlv2-base-patch16-ensemble", do_pad=False)
